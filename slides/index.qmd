...
>>>>>>> 70d83fdf02ec33bc6714b0e52a7eac4a9c33c71f
format:
  LUstyle-revealjs:
    self-contained: true
    footer: "[nrennie.github.io/rss-2024-tidymodels](https://nrennie.github.io/rss-2024-tidymodels)"
...
<<<<<<< HEAD
The workshop will run for *1 hour and 40 minutes*.
=======
...
* Load the {ggplot2movies} package.

* Load the `movies` data, and subset to remove the `title`, `budget`, `mpaa`, and `r?` columns.

* Create a binary outcome from the `rating` column, and ensure all binary columns are factors.
...
See `exercise_solutions/exercise_solutions_02.R` on GitHub for full code.
...
See `examples/example_05.R` for full code.

:::

## Exercise 5

Open `exercises/exercise_05.R` for prompts. You can also use `examples/example_05.R` as a starting point.
...
See `exercise_solutions/exercise_solutions_03.R` for full code. 
=======
See `exercise_solutions/exercise_solutions_05.R` for full code.
